...
<html lang="en">
    <head>
        ...
        <%
            Rating a = (Rating) request.getAttribute("rating");
                                ...
                                <div class="form-content">
                                    <div class="form-items">
                                        ...
                                        <div id="form1" class="my-5">
                                            ...
                                            <form action="ratingdetails?uid=<%=a.getUserid()%>&pid=<%=a.getProductid()%>&action=update"  method="post" class="requires-validation" is-validated>
                                                <input style="display:none;" name="uid" value="<%=a.getUserid()%>">
                                                <input style="display:none;" name="pid" value="<%=a.getProductid()%>">
                                                <div class="col-md-12">
                                                    <label class="" for="comment">Comment </label>
                                                    <input  value="<%=a.getComment()%>" class="form-control" type="text" name="comment" placeholder="ID" required>
                                                    <div class="valid-feedback">ID field is valid!</div>
                                                    <div class="invalid-feedback">ID field cannot be blank!</div>
                                                </div>
                                                <div class="col-md-12">
                                                    <label class="" for="value">Value </label>       <input class="form-control" id="value" value="<%=a.getRating()%>" type="number" min="1" max="5"  name="value" placeholder=" Name" required>
